...
call shtool tb_file     TB_FILE_IMPLEMENTATION
call shtool tb_hasmap   TB_HASMAP_IMPLEMENTATION
call shtool tb_json     TB_JSON_IMPLEMENTATION
call shtool tb_jwrite   TB_JWRITE_IMPLEMENTATION
